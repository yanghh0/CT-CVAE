...
class TransformerLinearWrapper(nn.Module):
    ...
    def __init__(self, transformer: TransformerEncoder, output_dim: int):
        ...
        input_dim = transformer.context_encoder.out_dim
        self.additional_linear_layer = nn.Linear(input_dim * 2, output_dim)
        # self.additional_linear_layer = nn.Sequential(
    ...
    def forward(self, *args) -> torch.Tensor:
        ...
        """
        context_h, _ = self.transformer(*args)
